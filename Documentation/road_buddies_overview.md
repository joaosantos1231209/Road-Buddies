...
* **Autenticação Google Integrada**: Acesso rápido e seguro utilizando a conta corporativa. O sistema extrai automaticamente o nome, e-mail e foto de perfil. Ou autenticação por Email/Palavra-Passe.
...
* **Perfis de Utilizador**:
  * **Identidade**: Nome, e-mail e telemóvel (opcional).
...
* **Dashboards Inteligentes**:
  ...
  * **Minhas Viagens**: Central de controlo para as viagens onde o utilizador participa, dividida em:
    ...
    * *Pedidos de Viatura*: Histórico de requisições Serviços Partilhados (SP).

## 3. Motor de Matchmaking e Notificações

* **Cruzamento Automático**: O sistema analisa os pedidos e ofertas. Se houver compatibilidade de trajeto e horário, o utilizador que pede a boleia vê a sugestão no separador "Matches".
...
* **Notificações por E-mail**: Envio automático de e-mails quando:
  * Um passageiro reserva lugar numa viagem, para o condutor.
  * Uma viagem é cancelada pelo condutor, para os passageiros.
  * Um match é encontrado, para o passageiro.
  * Um colaborador solicita uma viatura aos SP.
...
* Funcionalidade dedicada para deslocações de trabalho que requerem uma viatura da frota mas não envolvem carsharing (pode depois envolver).
* Inclui formulário de justificação e envio de relatório para os SP.
...
*Documento atualizado em: 30 de Março de 2026*
